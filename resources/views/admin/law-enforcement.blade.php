...
@section('contents')
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-15">
        <div class="d-flex align-items-center gap-8">
            ...
            <h6 class="card-title text-18">Mange Law Enforcement Personnel</h6>
        </div>
    </div>
                            ...
                            @if($volunteer->documents)
                                <div class="document-images-wrapper align-items-center">
                                    <div class="document-image">
                                        <a href="{{ asset("assets/uploads/law-enforcement/documents/{$volunteer->documents?->nid_front_side}") }}" target="_blank">
                                            <img src="{{ asset("assets/uploads/law-enforcement/documents/{$volunteer->documents?->nid_front_side}") }}"
                                    ...
                                    <div class="document-image">
                                        <a href="{{ asset("assets/uploads/law-enforcement/documents/{$volunteer->documents?->nid_back_side}") }}" target="_blank">
                                            <img src="{{ asset("assets/uploads/law-enforcement/documents/{$volunteer->documents?->nid_back_side}") }}"
                                    ...
                                    <div class="document-image">
                                        <a href="{{ asset("assets/uploads/law-enforcement/documents/{$volunteer->documents?->job_id_card}") }}" target="_blank">
                                            <img src="{{ asset("assets/uploads/law-enforcement/documents/{$volunteer->documents?->job_id_card}") }}"
                                                 alt="Job ID Card" class="document-image-view" width="60" height="60">
                                            <p>Job ID</p>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <td>
                            @if(! $volunteer->documents?->approved)
                                <a class="btn btn-success-fill btn-sm"
                                   href="{{ route('admin.law-enforcements.approve', $volunteer->id) }}">
                                    Approve
                                </a>
                            @else
                                <a class="btn btn-danger-fill btn-sm"
                                   href="{{ route('admin.law-enforcements.cancel', $volunteer->id) }}">
                                    Cancel
                                </a>
                            @endif
                        </td>
